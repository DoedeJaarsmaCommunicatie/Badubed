...
function badubed_scripts() {
	...
	wp_enqueue_style( 'badubed-main-style', get_stylesheet_uri() . '/dist/styles/main.css' );
	
	wp_enqueue_script( 'main', get_stylesheet_uri() . '/dist/scripts/main.js', ['jquery'], null, true );
	
	wp_enqueue_script( 'badubed-navigation', get_stylesheet_uri() . '/dist/scripts/navigation.js', [], '20151215', true );
	
	wp_enqueue_script( 'badubed-skip-link-focus-fix', get_stylesheet_uri() . '/dist/scripts/skip-link-focus-fix.js', [], '20151215', true );
